...
import { getProfileInfo } from '../../../../redux/Profile/ProfileSelectors';
import { settingsSchema } from '../../../../utils/validators/validator';
import { createFormError } from '../../../../utils/form-helper';
import Button from '../../../Common/Button/Button';

const Settings = React.memo(({updateProfileProperties, savePhoto}) => {
    ...
    const isProfileUpdate = useSelector((state) => state.profile.isProfileUpdate);
    const serverErrorMessages = useSelector((state) => state.profile.errorMessage);
